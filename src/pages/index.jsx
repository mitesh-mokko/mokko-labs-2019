...
const Index = () => (
  <>
    ...
    <Parallax pages={5}>
      <Hero offset={0}>
        <BigTitle>
          Hello, <br /> we are Mokko Labs.
        </BigTitle>
        <Subtitle>
          We bring digital products to life with design and technology expertise
      ...
      <Contact offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:mitesh@mokko.io">Hi</a> or find us on other
            platforms: <a href="https://dribbble.com/mokko-labs">Dribbble</a>
          </ContactText>
        </Inner>
        <Footer>&copy; 2019 Mokko Labs / Mokko LLC.</Footer>
      </Contact>
    </Parallax>
  </>
);
